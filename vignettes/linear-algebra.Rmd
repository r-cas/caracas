...
FIXME: Need caracas form as well.
...
### Reduced row-echelon form (rref); FIXME: What is this doing?
...
### Column space, row space and null space [FIXME]

```{r}
##B <- as_sym("3, 3, [1, 3, 0, -2, -6, 0, 3, 9, 6]") ## FIXME ???
